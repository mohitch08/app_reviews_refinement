...
train_df = pd.DataFrame({
    ...
    "Prompt6_Output" : df['Ground_Truth'],
})

# Creating train dataset from dataframe of dictionary
...
refined_model = "Prompt6_Mistral_app_reviews" #You can give it your own name
...
# LoRA Config  for fineuning the model
